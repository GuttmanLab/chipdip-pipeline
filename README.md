...
1. <a name="working-directory">**Working directory**</a>: We follow the [Snakemake documentation](https://snakemake.readthedocs.io/en/stable/project_info/faq.html#id9) in using the term "working directory" to refer to the
...
3. <a name="input-directory">Input directory</a>: where configuration files reside
   - `assets/`
   - `cluster.yaml`
   - `config.yaml`: paths are specified relative to the [working directory](#working-directory)
